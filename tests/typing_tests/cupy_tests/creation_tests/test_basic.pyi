...
xp.empty(
    (10, 20), float, "K"
)  # E: Argument 3 to "empty" has incompatible type [arg-type]
xp.empty(
    (10, 20), float, "A"
)  # E: Argument 3 to "empty" has incompatible type [arg-type]
xp.empty(
...
xp.ones(
    (10, 20), float, "K"
)  # E: Argument 3 to "ones" has incompatible type [arg-type]
xp.ones(
    (10, 20), float, "A"
)  # E: Argument 3 to "ones" has incompatible type [arg-type]
...
xp.zeros(
    (10, 20), float, "K"
)  # E: Argument 3 to "zeros" has incompatible type [arg-type]
xp.zeros(
    (10, 20), float, "A"
)  # E: Argument 3 to "zeros" has incompatible type [arg-type]
...
xp.full(
    (10, 20), 30, float, "K"
)  # E: Argument 4 to "full" has incompatible type [arg-type]
xp.full(
    (10, 20), 30, float, "A"
)  # E: Argument 4 to "full" has incompatible type [arg-type]
