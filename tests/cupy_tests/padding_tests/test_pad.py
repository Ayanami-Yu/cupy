    ...
    def test_pad(self, xp, dtype):
        ...
        def f():
            if self.mode == "constant":
                ...
                return xp.pad(
                    array, self.pad_width, mode=self.mode, stat_length=self.stat_length
                )
...
@testing.parameterize(
    ...
    {"array": [0, 1, 2, 3], "pad_width": 1, "mode": "constant", "constant_values": 3},
    {
        "array": [0, 1, 2, 3],
        "pad_width": [1, 2],
        "mode": "constant",
...
@testing.parameterize(
    ...
    {"array": [0, 1, 2, 3], "pad_width": [-1, 1], "mode": "reflect", "kwargs": {}},
    {
        "array": [0, 1, 2, 3],
        "pad_width": [[3, 4], [5, 6]],
        "mode": "reflect",
