...
@testing.parameterize(
    ...
    {"shape": (3, 4, 5), "slices": (slice(0, 1), slice(1, 2), [1, -1]), "value": 1},
    {
        "shape": (3, 4, 5),
    ...
    {"shape": (2, 3, 4), "slices": [], "value": numpy.random.uniform(size=(3, 4))},
    {"shape": (2, 3, 4), "slices": numpy.array([], dtype=numpy.int32), "value": 1},
    {"shape": (2, 3, 4), "slices": ([],), "value": 1},
    {
        "shape": (2, 3, 4),
    ...
    {"shape": (2, 3, 4), "slices": ([], []), "value": 1},
    {"shape": (2, 3, 4), "slices": numpy.array([], dtype=numpy.bool_), "value": 1},
    {
        "shape": (2, 3, 4),
