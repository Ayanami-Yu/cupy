...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "transpose": None, "indexes": (1, None, slice(2), None, 2)},
    ...
    {"shape": (0, 1), "transpose": None, "indexes": (slice(None, None, -1), None)},
    {"shape": (1, 0), "transpose": None, "indexes": (None, slice(None, None, -1))},
    {
        "shape": (1, 0, 1),
        "transpose": None,
    ...
    #
    {"shape": (2, 0), "transpose": None, "indexes": (1, slice(None, None, None))},
)
