...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "indexes": (numpy.random.choice([False, True], (2, 3, 4)),)},
    {"shape": (2, 3, 4), "indexes": (slice(None), numpy.array([True, False, True]))},
    {
        "shape": (2, 3, 4),
        "indexes": (slice(None), slice(None), numpy.array([True, False, False, True])),
    },
    {"shape": (2, 3, 4), "indexes": (1, 2, numpy.array([True, False, False, True]))},
    {
        "shape": (2, 3, 4),
        "indexes": (slice(None), numpy.random.choice([False, True], (3, 4))),
    },
    {"shape": (2, 3, 4), "indexes": numpy.random.choice([False, True], (2, 3))},
    {"shape": (2, 3, 4), "indexes": (1, None, numpy.array([True, False, True]))},
    # empty arrays
    {"shape": (2, 3, 4), "indexes": []},
    ...
    {"shape": (2, 3, 4), "indexes": (slice(None), numpy.array([], dtype=numpy.bool_))},
    {"shape": (2, 3, 4), "indexes": numpy.array([[], []], dtype=numpy.bool_)},
    ...
    {"shape": (2, 3, 4), "indexes": (numpy.empty((0, 3), bool), numpy.empty(0, bool))},
    ...
    # issue #4799
    {"shape": (3, 4, 5), "indexes": (slice(None), [0, 1], Ellipsis, [0, 1])},
    {
        "shape": (2, 3, 4),
...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "transpose": (1, 0, 2), "indexes": (None, [1, 2], [0, -1])},
)
...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "indexes": ([True, True], [[True, True, False, False]])},
    {"shape": (2, 3, 4), "indexes": ([True, True], [[True], [True], [False]])},
    {"shape": (2, 3, 4), "indexes": numpy.empty((0, 1), bool)},
    {"shape": (2, 3, 4), "indexes": (numpy.empty(0, bool), numpy.empty((0, 2), bool))},
)
...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "indexes": (slice(0, 1), slice(1, 2), [1, -1]), "value": 1},
    {
        "shape": (2, 3, 4),
    ...
    {"shape": (2, 3, 4), "indexes": (1, numpy.array([True, False, True])), "value": 1},
    {"shape": (2, 3, 4), "indexes": (numpy.array([True, False]), 1), "value": 1},
    {
        "shape": (2, 3, 4),
    ...
    {
        "shape": (2, 3, 4),
        "indexes": (slice(None), slice(None), numpy.random.choice([False, True], (4,))),
        "value": 1,
    },
    {
        "shape": (2, 3, 4),
    ...
    {"shape": (2, 3, 4), "indexes": ([0, -1], slice(None), [1, -1]), "value": 1},
    {"shape": (2, 3, 4), "indexes": ([0, -1], 1, 2), "value": 1},
    {
        "shape": (2, 3, 4),
        "indexes": ([1, 0], slice(None), [[2, 0], [3, 1]]),
        "value": 1,
    },
    # multiple arrays and basic indexing
    {"shape": (2, 3, 4), "indexes": ([0, -1], None, [1, 0]), "value": 1},
    {"shape": (2, 3, 4), "indexes": ([0, -1], slice(0, 2), [1, 0]), "value": 1},
    {"shape": (2, 3, 4), "indexes": ([0, -1], None, slice(0, 2), [1, 0]), "value": 1},
    {
        "shape": (1, 1, 2, 3, 4),
    ...
    {"shape": (2, 3, 4), "indexes": [], "value": numpy.random.uniform(size=(3, 4))},
    {"shape": (2, 3, 4), "indexes": numpy.array([], dtype=numpy.int32), "value": 1},
    {
        "shape": (2, 3, 4),
    ...
    {"shape": (2, 3, 4), "indexes": ([], []), "value": 1},
    {"shape": (2, 3, 4), "indexes": numpy.array([], dtype=numpy.bool_), "value": 1},
    {
        "shape": (2, 3, 4),
    ...
    {"shape": (2, 3, 4), "indexes": (Ellipsis, numpy.ones((3, 4), bool)), "value": 1},
    # issue #4799
    {
        "shape": (3, 4, 5),
...
@testing.parameterize(
    ...
    {"shape": (2, 3, 4), "indexes": numpy.array(1), "value": numpy.array([1, 2, 3, 4])},
    {
        "shape": (2, 3, 4),
