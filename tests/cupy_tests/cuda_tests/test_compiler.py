...
class TestNvrtcArch(unittest.TestCase):
    ...
    @unittest.skipUnless(11000 <= cuda_version(), "Requires CUDA 11.0 or later")
    def test_get_arch_cuda11(self):
        self._check_get_arch("80", "80")

    @unittest.skipUnless(12080 <= cuda_version(), "Requires CUDA 12.8 or later")
    ...
    def test_compile_cuda9(self):
        ...
        # It should fail.
        self.assertRaises(compiler.CompileException, self._compile, "73")

    @unittest.skipUnless(10010 <= cuda_version() < 11000, "Requires CUDA 10.1 or 10.2")
    def test_compile_cuda101(self):
        ...
        self.assertRaises(compiler.CompileException, self._compile, "80")
    ...
    def test_compile_cuda11(self):
        ...
        # It should fail.
        self.assertRaises(compiler.CompileException, self._compile, "83")


class TestNvrtcStderr(unittest.TestCase):

    @unittest.skipIf(cupy.cuda.runtime.is_hip, "HIPRTC has different error message")
    def test1(self):
    ...
    @unittest.skipIf(not cupy.cuda.runtime.is_hip, "NVRTC has different error message")
    def test2(self):
