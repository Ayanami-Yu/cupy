...
class TestFreqz:
    ...
    def test_plot(self):
        ...
        pytest.raises(
            ZeroDivisionError, signal.freqz, [1.0], worN=8, plot=lambda w, h: 1 / 0
        )
...
class TestSOSFreqz:
    ...
    @pytest.mark.parametrize(
        "w", [[123], (123,), np.array([123]), (50, 123, 230), np.array([50, 123, 230])]
    )
    @testing.numpy_cupy_allclose(scipy_name="scp")
