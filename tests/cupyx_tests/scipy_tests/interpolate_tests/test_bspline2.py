...
class TestInterp:
    ...
    def test_order_0(self, xp, scp):
        x, y = self.get_xy(xp)
        return (
            scp.interpolate.make_interp_spline(x, y, k=0)(x),
    ...
    def test_string_aliases_2(self, xp, scp):
        ...
        b1 = scp.interpolate.make_interp_spline(
            x, y, k=3, bc_type=("natural", "clamped")
        )
    ...
    def test_string_aliases_6(self, xp, scp):
        ...
        b1 = scp.interpolate.make_interp_spline(
            x, yy, k=3, bc_type=("clamped", "natural")
        )
        return b1.c, b2.c
...
class TestLSQ:
    ...
    def _get_xytk(self, xp, n=13, k=3):
        ...
        t = _np.r_[(x[0],) * k, _np.linspace(x[0], x[-1], 7), (x[-1],) * k]
...
class TestGivensQR:
    ...
    def test_py_vs_compiled(self):
        ...
        from cupyx.scipy.interpolate._bspline2 import QR_MODULE, _get_module_func

        qr_reduce = _get_module_func(QR_MODULE, "qr_reduce")
        qr_reduce((1,), (1,), (A, m, k + 1, offset, nc, y_, y_.shape[1], 1))
