...
class TestBeta:
    ...
    @pytest.mark.skipif(
        cupy.cuda.runtime.is_hip and cupy.cuda.runtime.runtimeGetVersion() < 5_00_00000,
...
class TestBetaInc:
    ...
    def test_betainc_specific_vals(self):
        ...
        testing.assert_allclose(
            special.betainc(0.0342, 171, 1e-10), 0.55269916901806648
        )
    ...
    def test_betaincinv_specific_vals(self):
        ...
        testing.assert_allclose(
            special.betaincinv(0.0342, 171, 0.25),
